...
[![Coverage status](https://coveralls.io/repos/github/pmcharrison/incon/badge.svg)](https://coveralls.io/r/pmcharrison/incon?branch=master)
...
tribble(
  ...
  mutate(GitHub = paste("https://github.com/pmcharrison/", 
                        Package,
                        sep = ""),
         DOI = sprintf("[%s](https://doi.org/%s)", DOI, DOI)) %>% 
  kable
```
...
Harrison, P. M. C., & Pearce, M. T. (in prep.). Instantaneous consonance in the perception and composition of Western music.
